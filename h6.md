...
Ensin syötin `salt-call –-local user`, josta tuli manuaalin kaltainen tuloste. Sen jälkeen syötin komennon, jolla näin mihin ryhmään käyttäjäni Liisa kuuluu ja toisella komennolla katsoin tietokoneen paikalliset käyttäjät:
