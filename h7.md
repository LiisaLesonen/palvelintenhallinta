...
Ensin tein palomuuriin reiän, asensin käsin isännälle onnistuneesti MariaDB:n, sitten yritin samaa orjakoneille. En saanut init.sls-tiedostoa luomalla asennettua orjille tietokantaa (sisennykset ovat oikein "pkg:s" jälkeen, vaikka tuossa kuvassa ei näykään niin, eli taas 2 riviä alkuun tyhjää):
